...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<API.ProxyIpListItem>[] = [
    ...
    },
    {
      ...
      dataIndex: 'type',
      valueEnum: {
        0: { text: 'http', status: 'Default' },
        1: { text: 'https', status: 'Success' },
      },
    },
    {
      title: '是否有效',
    ...
    <PageContainer>
      <ProTable<API.ProxyIpListItem, API.PageParams>
        ...
        request={async (params) => {
          const response = await fetchProxyIpPage({ ...params });
          return {
      ...
      <ModalForm
        ...
        onFinish={async (value) => {
          const success = await handleAdd(value as API.ProxyIpListItem);
          if (success) {
